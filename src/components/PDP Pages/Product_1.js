    ...
    <>
      <Container className="prod_container">
        ...
        <Row>
          ...
          <Col lg={6} md={6} sm={12}>
            <h3>ADRENALINE</h3>
            <h1>Ride through the Sahara Desert</h1>
            <p>
              ...
              before they’re willing to raise their hand and become a lead, let
              alone before they book.
              <br /> A well-constructed content strategy will drive every aspect
              of your customer lifecycle, building trust to convert leads and
              transforming current customers into recurring brand champions.
              Check out these 5 ideas below for content that can capture your
              brand and resonate with your audience. For each idea, we’ll give a
              live example from another adventure travel company and cover its:
            </p>
            ...
            <div className="spot">
              <div className="spot_card">
                <img
                  src="https://images.unsplash.com/photo-1509316785289-025f5b846b35?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=876&q=80"
                  alt="ic_spot"
                />
