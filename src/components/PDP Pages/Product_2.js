...
import "./PDP.css";
import { data_2 } from "../../data/similar_destination_data";
import { Link } from "react-router-dom";

import { Container, Row, Col, Carousel, Card } from "react-bootstrap";
import StarRating from "../StarRating";
import { pdp_data_1 } from "../../data/pdp_data";

function Product_2({ addCart }) {
  return (
    <>
            ...
            <Carousel>
              <Carousel.Item>
                <img
                  ...
                  src="https://images.unsplash.com/photo-1590523277543-a94d2e4eb00b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1032&q=80"
                  alt="First Slide"
                />
              </Carousel.Item>
              <Carousel.Item>
                <img
                  className="d-block w-100"
                  src="https://images.unsplash.com/photo-1516815231560-8f41ec531527?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=867&q=80"
                  alt="Second slide"
                  height="307px"
                  width="546px"
                />
              ...
              <Carousel.Item>
                <img
                  className="d-block w-100"
                  src="https://images.unsplash.com/photo-1576158831003-d41033ec31fd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
                  alt="Third slide"
                  height="307px"
                  width="546px"
                />
              ...
              <Row className="icon_container">
                <Col lg={4} md={2}>
                  <img
                    ...
                    src="https://img.icons8.com/nolan/344/rice-bowl.png"
                    width="50px"
                    alt="Food"
                  />
                </Col>
                <Col lg={4} md={2}>
                  <img
                    src="https://img.icons8.com/nolan/344/beach.png"
                    width="50px"
                    alt="Hotel"
                  />
                </Col>
                <Col lg={4} md={2}>
                  <img
                    src="https://img.icons8.com/nolan/344/car.png"
                    width="50px"
                    alt="Travel"
                  />
                </Col>
